...
app.layout = html.Div([
        ...
        html.Div(id='content-wrapper', className='container', children=[
            html.Div(id='left-content-wrapper', className='main-container', children=[
                html.Div(id='counters', className='boxes',children=[
